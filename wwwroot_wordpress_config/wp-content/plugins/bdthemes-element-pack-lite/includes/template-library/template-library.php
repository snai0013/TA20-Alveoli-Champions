...
LEFT JOIN {$catTable} ON {$catTable}.term_id = {$postCatTable}.term_id 
 $keywordSearch");
        ...
        // Load all datas
        $allPagesData = $this->wpdb->get_results("SELECT {$postTable}.*, {$postCatTable}.term_id, {$catTable}.slug FROM {$postTable}
 LEFT JOIN {$postCatTable} ON {$postTable}.demo_id = {$postCatTable}.demo_id 
LEFT JOIN {$catTable} ON {$catTable}.term_id = {$postCatTable}.term_id
            ...
            <?php if ( is_array( $demoData ) ) : ?>
                <div class="bdt-template-library">
                    <div id="bdt-template-library-params">
                        ...
                        <input type="hidden" class="bdt-template-sort-by-title" value="asc"/>
                            ...
                            <div class="bdt-sidebar-container bdt-height-1-1">
                                ...
                                <ul class="bdt-list bdt-list-divider">
                                    <li class="bdt-active template-category-item demo_term_all_tab"
                                        data-demo="demo_term_all"><a href="javascript:void(0)">All Templates <span class="bdt-badge"><?php echo esc_attr($this->demo_total); ?></span></a></li>
                                    <?php
