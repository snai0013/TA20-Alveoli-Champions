...
class FcpShortCodes {
	...
	public static function fcp_water_intake_calculator( $atts, $content = "" ) {
		...
		$fcw_metric_only = '';
		if(trim(get_option('fcw_metric_only'))!=false)
		{
			$fcw_metric_only = get_option('fcw_metric_only');	
		}
		...
		$html .= '#fcp-water-intake-form h3 {
			...
			$html .= '<table class="fcp-table">
			  			...
			  			<tr><td><button onclick="fcpCalculateWaterIntake()" class="btn btn-default fcp-btn">'. __( 'Calculate', 'fitness-calculators' ) .'</button></td><td></td></tr>
			  		</tbody></table>
	...
	public static function fcp_protein_intake_calculator( $atts, $content = "" ) { 
		...
		$html .= '<table class="fcp-table">
			  			...
			  			<tr><td><button onclick="fcpCalculateproteinIntake()" class="btn btn-default fcp-btn">'. __( 'Calculate', 'fitness-calculators' ) .'</button></td><td></td></tr>
			  		</table>
	...
	public static function fcp_bmi_calculator( $atts, $content = "" ) { 
		...
		$html .= '#fcp-bmi-intake-form h3 {
			...
			$html .= '<table class="fcp-table">
			  			...
			  			<tr><td><button onclick="fcpCalculatebmiIntake()" class="btn btn-default fcp-btn">'. __( 'Calculate', 'fitness-calculators' ) .'</button></td><td></td></tr>
			  		</table>
	...
	public static function fcp_bfc_calculator( $atts, $content = "" ) { 
		...
		$html .= '#fcp-bfc-intake-form h3 {
			  ...
			  <div class="fcp-row">
			  		<div class="fcp-radio-btn fcp-radio-btn-bfc-metric">
			  			<label for="fcp-bfc-intake-radio-metric">'. __( 'Metric', 'fitness-calculators' ) .'</label>
			  			 <input type="radio"  id="fcp-bfc-intake-radio-metric" class="form-control fcp-protein-radio" name="fcp-bfc-intake-radio" checked="checked" value="metric">
			  			<span class="fcp-error">require</span>
			  		</div>';
			...
			$html .= '<table class="fcp-table">
			  			...
			  			<tr><td><button onclick="fcpCalculatebfcIntake()" class="btn btn-default fcp-btn">'. __( 'Calculate', 'fitness-calculators' ) .'</button></td><td></td></tr>
			  		</table>
