...
class Style6 extends Render {

    public function default_render($style, $child, $admin) {
        echo '<div class="oxi-tabs-ultimate-style oxi-tabs-ultimate-template-6 ' . $this->headerclass . '  oxi-tab-clearfix" data-oxi-tabs=\'' . json_encode($this->attribute) . '\'>';
        /*
