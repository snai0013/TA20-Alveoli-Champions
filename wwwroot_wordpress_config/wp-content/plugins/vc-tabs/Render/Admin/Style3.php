...
class Style3 extends Helper {
    ...
    public function register_header_general() {
        ...
        $this->add_responsive_control(
                'oxi-tabs-head-transform-width', $this->style, [
            'label' => __('Header Transform', OXI_TABS_TEXTDOMAIN),
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-tabs-ultimate-style .oxi-tabs-header-li' => 'left:{{SIZE}}{{UNIT}};top:{{SIZE}}{{UNIT}};right:{{SIZE}}{{UNIT}};bottom:{{SIZE}}{{UNIT}};',
            ],
            'description' => 'Set header transform size, Transform direction will automatically set depend on design.',
                ]
        );
