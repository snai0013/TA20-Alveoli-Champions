    ...
    class Busyness_Recent_Post extends WP_Widget {
        ...
        public function __construct() {
            $tp_widget_popular_post = array(
                ...
                'description' => esc_html__( 'Retrive Recent posts.', 'busyness' ),
            );
            parent::__construct( 'movie_pro_recent_post', esc_html__( 'TP : Recent Posts', 'busyness' ), $tp_widget_popular_post );
        }
