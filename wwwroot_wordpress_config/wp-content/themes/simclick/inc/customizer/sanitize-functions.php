 ...
 */
function simclick_sanitize_select( $input, $setting ) {
 ...
 */
function simclick_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function simclick_sanitize_post( $input ) {
 ...
 */
function simclick_sanitize_image( $image, $setting ) {
	/*
 ...
 * @since SimClick 0.1
 */
function simclick_sanitize_category_list( $input ) {
	if ( '' != $input ) {
		if( in_array( 0, $input ) ) {
			return '0';
		}
 ...
 *                    the setting default.
 */
function simclick_sanitize_number_range( $number, $setting ) {
